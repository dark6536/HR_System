		...
		<div id = "div_right">
			<table border="1px" cellpadding="0" cellspacing="0" class = "table_query">
				...
				<tr>
					...
					<td>${trains.time}</td>
					<td>${trains.status}</td>
					<td><a href = "updateTrain?id=${trains.id}" class = "update">EDIT</a></td>
					<td><a href = "deleteTrain?id=${trains.id}" class = "del">DELETE</a></td>
					<td><a href = "queryDetail?id=${trains.id}">DETAIL</a></td>
				</tr>
				</c:forEach>	
			</table>
		</div>
