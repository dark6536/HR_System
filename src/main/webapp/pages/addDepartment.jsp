...
<body>
	...
	<div id = "div_main">
		...
		<div id = "div_right">
				<form action = "addDepartmentInput" id = "addDepartment">
					<table>
						<tr>
							<td>输入新部门名称：<input type = "text" name = "name" required="required" id = "name"></td>
						</tr>
						<tr>
							<td>输入新部门经理工号
							<input type = "number" name = "manager_id" required="required" id = "manager_id">
							经理名称：<input type = "text" name = "manager_name" id = "manager_name" disabled="disabled">
							</td>
						</tr>
						<tr>	
